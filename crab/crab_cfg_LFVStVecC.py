...
config.General.requestName = 'NanoPostprocessorLFVtest_LFVStVecC_2FilesPerJob_FulldatasetTest'
...
config.Data.outLFNDirBase = '/store/user/%s/NanoPosttest_LFVStVecC' % ( 'asparker' )
# getUsernameFromSiteDB())
