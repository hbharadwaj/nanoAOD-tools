...
class MyAnalysisCC(Module ):
    def __init__(self, isdata, afileList, loopInfo ):
        ...
        base = "/afs/cern.ch/user/a/asparker/public/LFVTopCode_MyFork/nanoAODtools_crab_mc/"
        
        ROOT.gSystem.Load("libPhysicsToolsNanoAODTools.so")
        print "Load(BASE/TopLFV/lib/main.so"
        gSystem.Load("%sTopLFV/lib/main.so"%(base) )
        gInterpreter.ProcessLine('#include'+ '"%sTopLFV/include/MyAnalysis.h"'%(base))
